...
# Parametr wygładzania ruchu (mniejsza wartość = szybsze poruszanie)
smooth_factor = 0.05  # Zmniejszona wartość dla szybszego ruchu

# Zmienne do śledzenia stanu uszczypnięcia
is_left_pinching = False
is_right_pinching = False

# Próg odległości dla uszczypnięcia
pinch_threshold = 50

# Opóźnienie w milisekundach między klatkami (mniejsza wartość = szybsze przetwarzanie)
frame_delay = 5  # Zmniejszona wartość dla szybszego przetwarzania
    ...
    while True:
        ...
        if results_hands.multi_hand_landmarks:
            for hand_landmarks in results_hands.multi_hand_landmarks:
                # Rysowanie punktów orientacyjnych
                ...
                pyautogui.moveTo(smoothed_x, smoothed_y, duration=0.005)  # Zmniejszona wartość duration
